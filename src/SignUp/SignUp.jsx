        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="form-control">
              ...
              {errors.password?.type === 'maxLength' && <span className="text-red-500">This must be less than 20 characters</span>}
            </div>
          ...
          <p className="text-center mb-5 text-xl">
            <small>Already have an account? <Link className="text-blue-700 font-bold" to="/login">Login</Link></small>
          </p>
          <SocialLogin />
        </div>
      </div>
